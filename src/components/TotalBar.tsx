...
export const TotalBar = () => {
    ...
    return (
        <div className="pt-8 flex justify-around rounded-lg shadow-md pb-8">
            <div className="flex gap-2"><Utensils className="text-gray-500" /> Total calories: {calories}</div>
            <div className="flex gap-2"><Beef className="text-gray-500" />Total protein: {protein}</div>
            <div className="flex gap-2"><Banana className="text-gray-500" />Total carbs: {carbs}</div>
            <div className="flex gap-2"><IceCream className="text-gray-500" />  Total fats: {fats}</div>
        </div>
    )
}